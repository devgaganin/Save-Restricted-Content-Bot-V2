...
**Note** : This repository contains three branches `login` as default branch `main` as main branch and `standalone` | `main` branch codes and `standalone` branch code written by me while `login` branch code is leaked premium source.
