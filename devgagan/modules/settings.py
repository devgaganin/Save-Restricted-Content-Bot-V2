...
# ------------------- I'm disabling this command if you wish you can use it i am going to create anothe command similar to this in get_func.py -------------#

@app.on_message(filters.command("depreciatedsettings") & filters.private)
